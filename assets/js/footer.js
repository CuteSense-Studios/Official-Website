            ...
            <div class="max-w-6xl mx-auto">
                <div class="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
                    ...
                    <div class="flex items-center gap-4 text-center md:text-left">
                        <img src="${path}assets/icons/companylogo.webp" alt="CuteSense Studios Logo" class="w-auto opacity-90" style="height: 36px;">
                        <div class="flex flex-col justify-center translate-y-1.5 pt-1">
                            <span class="text-2xl gradient-text borel-font block leading-none">CuteSense Studios</span>
                            <p class="text-[9px] uppercase tracking-[0.2em] font-bold text-cs-lilac opacity-70 mt-1">Art with Heart • © 2026 • Built with Gemini</p>
                        </div>
                    </div>
